    ...
    return (
        <div className='FindPlace'>
            <div className='FindPlaceP'>
                ...
                <p className='FindPlaceP1'>여행지를 검색하거나 목록에서 직접 선택해주세요</p>
            </div>
            <div className='FindPlace_country'>
                ...
                <div className='FindPlace_country_Canada'>
                    <div className='FindPlace_country_Canada_left'>
                        <div>
                    ...
                    <div className='FindPlace_country_Canada_right'>
                        <p>
                            캐나다 서부 BC 주에서 가장 큰 도시인 벤쿠버는 매년 세계에서 살기 좋은 도시 순위에서 5위
                            안에 손꼽히는 인기 지역이다. 다양한 인종과 문화가 공존하는 멜팅팟으로 유명하며 사회 전반에
                            다양한 인종들이 진출해있다. 한국계 캐나다인 중 최초로 연방 상원 의원에 선출된 연아 마틴의 연고지로도 유명하다.                        </p>
                        <div>
                            <i></i>
                            <i></i>
                            <i></i>
